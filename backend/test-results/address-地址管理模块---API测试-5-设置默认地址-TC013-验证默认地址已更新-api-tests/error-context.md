...
- Name: address.spec.js >> 地址管理模块 - API测试 >> 5. 设置默认地址 >> TC013: 验证默认地址已更新
- Location: tests\address.spec.js:276:5

# Error details

```
TypeError: Cannot read properties of null (reading 'dftIndc')
```
